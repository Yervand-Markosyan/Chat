    ...
    return (
      <div className="chatInfo" key={this.props._id}>
        <div className="personAbout">
          <div className="avatar" style={{backgroundImage: "url( https://mir-avatarok.3dn.ru/avatarki/specnaz/5f0a48f8c2cf4980db22d4f1881024c3.jpg)", }} ><div className="online"></div></div>
